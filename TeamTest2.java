...
public class TeamTest2{
  public static void main(String[] args){
    ...
    // Build one team
    String[] team1Schedule = {"01/03","01/08","01/15","00/00","02/01","02/08","02/15","02/22",
    ...
    // Build a third team
    String[] team3Schedule = {"01/02","01/08","01/15","01/22","02/01","02/08","02/15","02/22",
    ...
    // Test Check Schedule
    Team[] pair = {team1,team4};
    System.out.println(Team.checkSchedule(pair, "01/01"));
    ...
    System.out.println();
//    
    System.out.println("Teams 1, 3, 4 Total Sales During Week 1:");
    Team[] matchup2 = {team1,team3,team4};
    ...
    System.out.println("Team 2 Total Sales During Week 1:");
    Team[] matchup4 = {team2};
