...
public class FacultyExpense extends ExpenseAccount {
    private static double BUDGET = 2000.00;
/**
 * This is the  Faculty Expense constructor with 3 parameters.
 ...
 * @return  No return
 */
    public FacultyExpense(String accountName, double balance, double creditCardFee) {
        // No one charge can be more than $500
      super(accountName, balance, creditCardFee, 500);
    }
    /**
 ...
 */
    ...
    public void applyFee() {
        this.currentCharge += Math.round((this.currentCharge * getFee() * 100.0) / 100.0);
    }
/**
 ...
 * @return void
 */
    public void makePayment(double charge) throws AccountDepletedException, SuspiciousChargeException{
      BUDGET -= charge;
